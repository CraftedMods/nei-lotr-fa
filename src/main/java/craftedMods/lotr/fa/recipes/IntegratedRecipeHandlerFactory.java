...
import eoa.lotrfa.common.recipe.LOTRFARecipes;
...
public class IntegratedRecipeHandlerFactory implements RecipeHandlerFactory
{
    ...
    static
    {
        ...
        IntegratedRecipeHandlerFactory.registerFACTHandler (IntegratedRecipeHandlerFactory.FACTION_DOR_NA_DAERACHAS,
            LOTRBlockTableDorNaDaerachas.Gui.class,
            LOTRFARecipes.dorNaDaerachasRecipes);
        IntegratedRecipeHandlerFactory.registerFACTHandler (IntegratedRecipeHandlerFactory.FACTION_DORIATH,
            LOTRBlockTableDoriath.Gui.class,
            LOTRFARecipes.doriathRecipes);
        IntegratedRecipeHandlerFactory.registerFACTHandler (IntegratedRecipeHandlerFactory.FACTION_DOR_LOMIN,
            LOTRBlockTableDorLomin.Gui.class,
            LOTRFARecipes.dorLominRecipes);
        IntegratedRecipeHandlerFactory.registerFACTHandler (IntegratedRecipeHandlerFactory.FACTION_FALATHRIM,
            LOTRBlockTableFalathrim.Gui.class,
            LOTRFARecipes.falathrimRecipes);
        IntegratedRecipeHandlerFactory.registerFACTHandler (IntegratedRecipeHandlerFactory.FACTION_FEANORIAN,
            LOTRBlockTableFeanorian.Gui.class,
            LOTRFARecipes.feanorianRecipes);
        IntegratedRecipeHandlerFactory.registerFACTHandler (IntegratedRecipeHandlerFactory.FACTION_GONDOLIN,
            LOTRBlockTableGondolin.Gui.class,
            LOTRFARecipes.gondolinRecipes);
        IntegratedRecipeHandlerFactory.registerFACTHandler (IntegratedRecipeHandlerFactory.FACTION_HITHLUM,
            LOTRBlockTableHithlum.Gui.class,
            LOTRFARecipes.hithlumRecipes);
        IntegratedRecipeHandlerFactory.registerFACTHandler ("houseBor", LOTRBlockTableHouseBor.Gui.class,
            LOTRFARecipes.houseBorRecipes);
        IntegratedRecipeHandlerFactory.registerFACTHandler ("houseUlfang", LOTRBlockTableHouseUlfang.Gui.class,
            LOTRFARecipes.houseUlfangRecipes);
        IntegratedRecipeHandlerFactory.registerFACTHandler (IntegratedRecipeHandlerFactory.FACTION_LAEGRIM,
            LOTRBlockTableLaegrim.Gui.class,
            LOTRFARecipes.laegrimRecipes);
        IntegratedRecipeHandlerFactory.registerFACTHandler (IntegratedRecipeHandlerFactory.FACTION_NARGOTHROND,
            LOTRBlockTableNargothrond.Gui.class,
            LOTRFARecipes.nargothrondRecipes);
        IntegratedRecipeHandlerFactory.registerFACTHandler (IntegratedRecipeHandlerFactory.FACTION_PETTY_DWARF,
            LOTRBlockTablePettyDwarven.Gui.class,
            LOTRFARecipes.pettyDwarvenRecipes);
        IntegratedRecipeHandlerFactory.registerFACTHandler (IntegratedRecipeHandlerFactory.FACTION_TOL_IN_GAURHOTH,
            LOTRBlockTolInGaurhothTable.Gui.class,
            LOTRFARecipes.tolInGaurhothRecipes);
        ...
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityBorFarmer.class,
            IntegratedRecipeHandlerFactory.FACTION_BOR,
            LOTRFATrades.bor_farmer_sell, LOTRFATrades.bor_farmer_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityBorGreengrocer.class,
            IntegratedRecipeHandlerFactory.FACTION_BOR,
            LOTRFATrades.bor_greengrocer_sell, LOTRFATrades.bor_greengrocer_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityBorBlacksmith.class,
            IntegratedRecipeHandlerFactory.FACTION_BOR,
            LOTRFATrades.bor_smith_sell, LOTRFATrades.bor_smith_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityBorBaker.class,
            IntegratedRecipeHandlerFactory.FACTION_BOR,
            LOTRTradeEntries.DALE_BAKER_SELL, LOTRTradeEntries.DALE_BAKER_BUY);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityBrethilButcher.class,
            IntegratedRecipeHandlerFactory.FACTION_BRETHIL,
            LOTRFATrades.brethil_butcher_sell, LOTRFATrades.brethil_butcher_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityBrethilLumberman.class,
            IntegratedRecipeHandlerFactory.FACTION_BRETHIL,
            LOTRFATrades.brethil_lumberman_sell, LOTRFATrades.brethil_lumberman_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityBrethilSmith.class,
            IntegratedRecipeHandlerFactory.FACTION_BRETHIL,
            LOTRFATrades.brethil_smith_sell, LOTRFATrades.brethil_smith_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityDoriathBaker.class,
            IntegratedRecipeHandlerFactory.FACTION_DORIATH,
            LOTRFATrades.doriath_baker_sell, LOTRFATrades.doriath_baker_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityDoriathHuntsman.class,
            IntegratedRecipeHandlerFactory.FACTION_DORIATH,
            LOTRFATrades.doriath_huntsman_sell, LOTRFATrades.doriath_huntsman_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityDoriathLumberman.class,
            IntegratedRecipeHandlerFactory.FACTION_DORIATH,
            LOTRFATrades.doriath_lumberman_sell, LOTRFATrades.doriath_lumberman_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityDoriathSmith.class,
            IntegratedRecipeHandlerFactory.FACTION_DORIATH,
            LOTRFATrades.doriath_smith_sell, LOTRFATrades.doriath_smith_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityAnfauglithHuntsman.class,
            IntegratedRecipeHandlerFactory.FACTION_ANFAUGLITH,
            LOTRFATrades.anfauglith_huntsman_sell, LOTRFATrades.anfauglith_huntsman_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityAnfauglithScavenger.class,
            IntegratedRecipeHandlerFactory.FACTION_ANFAUGLITH,
            LOTRFATrades.anfauglith_scavenger_sell, LOTRFATrades.anfauglith_scavenger_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityAnfauglithTrader.class,
            IntegratedRecipeHandlerFactory.FACTION_ANFAUGLITH,
            LOTRFATrades.anfauglith_trader_sell, LOTRFATrades.anfauglith_trader_buy);

        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityDorNaDaerachasTrader.class,
            IntegratedRecipeHandlerFactory.FACTION_DOR_NA_DAERACHAS,
            LOTRFATrades.dor_na_daerachas_trader_sell, LOTRFATrades.dor_na_daerachas_trader_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityDorLominBrewer.class,
            IntegratedRecipeHandlerFactory.FACTION_DOR_LOMIN,
            LOTRFATrades.dor_lomin_brewer_sell, LOTRFATrades.dor_lomin_brewer_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityDorLominFarmer.class,
            IntegratedRecipeHandlerFactory.FACTION_DOR_LOMIN,
            LOTRFATrades.dor_lomin_farmer_sell, LOTRFATrades.dor_lomin_farmer_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityDorLominSmith.class,
            IntegratedRecipeHandlerFactory.FACTION_DOR_LOMIN,
            LOTRFATrades.dor_lomin_smith_sell, LOTRFATrades.dor_lomin_smith_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityDorLominBartender.class,
            IntegratedRecipeHandlerFactory.FACTION_DOR_LOMIN,
            LOTRTradeEntries.GONDOR_BARTENDER_SELL, LOTRTradeEntries.GONDOR_BARTENDER_BUY);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityFalathrimSmith.class,
            IntegratedRecipeHandlerFactory.FACTION_FALATHRIM,
            LOTRFATrades.falathrim_smith_sell, LOTRFATrades.falathrim_smith_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityFalathrimLumberman.class,
            IntegratedRecipeHandlerFactory.FACTION_FALATHRIM,
            LOTRFATrades.falathrim_lumberman_sell, LOTRFATrades.falathrim_lumberman_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityFalathrimFishmonger.class,
            IntegratedRecipeHandlerFactory.FACTION_FALATHRIM,
            LOTRTradeEntries.GONDOR_FISHMONGER_SELL, LOTRTradeEntries.GONDOR_FISHMONGER_BUY);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityFeanorianSmith.class,
            IntegratedRecipeHandlerFactory.FACTION_FEANORIAN,
            LOTRFATrades.feanorian_smith_sell, LOTRFATrades.feanorian_smith_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityFeanorianStablemaster.class,
            IntegratedRecipeHandlerFactory.FACTION_FEANORIAN,
            LOTRFATrades.feanorian_stablemaster_sell, LOTRFATrades.feanorian_stablemaster_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityGondolinFlorist.class,
            IntegratedRecipeHandlerFactory.FACTION_GONDOLIN,
            LOTRFATrades.gondolin_florist_sell, LOTRFATrades.gondolin_florist_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityGondolinSmith.class,
            IntegratedRecipeHandlerFactory.FACTION_GONDOLIN,
            LOTRFATrades.gondolin_smith_sell, LOTRFATrades.gondolin_smith_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityGondolinStonemason.class,
            IntegratedRecipeHandlerFactory.FACTION_GONDOLIN,
            LOTRFATrades.gondolin_stonemason_sell, LOTRFATrades.gondolin_stonemason_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityHithlumFlorist.class,
            IntegratedRecipeHandlerFactory.FACTION_HITHLUM,
            LOTRFATrades.hithlum_florist_sell, LOTRFATrades.hithlum_florist_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityHithlumGreengrocer.class,
            IntegratedRecipeHandlerFactory.FACTION_HITHLUM,
            LOTRFATrades.hithlum_greengrocer_sell, LOTRFATrades.hithlum_greengrocer_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityHithlumVinekeeper.class,
            IntegratedRecipeHandlerFactory.FACTION_HITHLUM,
            LOTRFATrades.hithlum_vinekeeper_sell, LOTRFATrades.hithlum_vinekeeper_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityHithlumVintnerElf.class,
            IntegratedRecipeHandlerFactory.FACTION_HITHLUM,
            LOTRTradeEntries.DORWINION_VINTNER_SELL, LOTRFATrades.hithlum_vintner_elf_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityHithlumSmith.class,
            IntegratedRecipeHandlerFactory.FACTION_HITHLUM,
            LOTRFATrades.hithlum_smith_sell, LOTRFATrades.hithlum_smith_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityLaegrimFlorist.class,
            IntegratedRecipeHandlerFactory.FACTION_LAEGRIM,
            LOTRFATrades.laegrim_florist_sell, LOTRFATrades.laegrim_florist_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityLaegrimHuntsman.class,
            IntegratedRecipeHandlerFactory.FACTION_LAEGRIM,
            LOTRFATrades.laegrim_huntsman_sell, LOTRFATrades.laegrim_huntsman_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityLaegrimLumberman.class,
            IntegratedRecipeHandlerFactory.FACTION_LAEGRIM,
            LOTRFATrades.laegrim_lumberman_sell, LOTRFATrades.laegrim_lumberman_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityLaegrimSmith.class,
            IntegratedRecipeHandlerFactory.FACTION_LAEGRIM,
            LOTRFATrades.laegrim_smith_sell, LOTRFATrades.laegrim_smith_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityNargothrondGoldsmith.class,
        ...
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityNargothrondStonemason.class,
            IntegratedRecipeHandlerFactory.FACTION_NARGOTHROND,
            LOTRFATrades.nargothrond_stonemason_sell, LOTRFATrades.nargothrond_stonemason_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityNargothrondTrader.class,
            IntegratedRecipeHandlerFactory.FACTION_NARGOTHROND,
        ...
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityTolInGaurhothTrader.class,
            IntegratedRecipeHandlerFactory.FACTION_TOL_IN_GAURHOTH,
            LOTRFATrades.tol_in_gaurhoth_trader_sell, LOTRFATrades.tol_in_gaurhoth_trader_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityTolInGaurhothLumberman.class,
            IntegratedRecipeHandlerFactory.FACTION_TOL_IN_GAURHOTH,
            LOTRFATrades.tol_in_gaurhoth_lumberman_sell, LOTRFATrades.tol_in_gaurhoth_lumberman_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityTormentedElfSmith.class,
            IntegratedRecipeHandlerFactory.FACTION_TORMENTED_ELF,
            LOTRFATrades.tormented_elf_smith_sell, LOTRFATrades.tormented_elf_smith_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityTormentedElfStonemason.class,
            IntegratedRecipeHandlerFactory.FACTION_TORMENTED_ELF,
            LOTRFATrades.tormented_elf_stonemason_sell, LOTRFATrades.tormented_elf_stonemason_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityUlfangBrewer.class,
            IntegratedRecipeHandlerFactory.FACTION_ULFANG,
            LOTRFATrades.ulfang_brewer_sell, LOTRFATrades.ulfang_brewer_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityUlfangButcher.class,
            IntegratedRecipeHandlerFactory.FACTION_ULFANG,
            LOTRFATrades.ulfang_butcher_sell, LOTRFATrades.ulfang_butcher_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityUlfangHuntsman.class,
            IntegratedRecipeHandlerFactory.FACTION_ULFANG,
            LOTRFATrades.ulfang_huntsman_sell, LOTRFATrades.ulfang_huntsman_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityUlfangLumberman.class,
            IntegratedRecipeHandlerFactory.FACTION_ULFANG,
            LOTRFATrades.ulfang_lumberman_sell, LOTRFATrades.ulfang_lumberman_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityUlfangSmith.class,
            IntegratedRecipeHandlerFactory.FACTION_ULFANG,
            LOTRFATrades.ulfang_smith_sell, LOTRFATrades.ulfang_smith_buy);
        IntegratedRecipeHandlerFactory.registerTraderHandler (LOTRFAEntityUlfangBartender.class,
            IntegratedRecipeHandlerFactory.FACTION_ULFANG,
        ...
        IntegratedRecipeHandlerFactory.recipeHandlers
            .add (new FAAlloyForgeRecipeHandler ("pettyDwarven",
                new FAAlloyForgeRecipeHandler.PettyDwarvenAlloyForgeAccess ()));
    }

    private static void registerFACTHandler (String unlocalizedName, Class<? extends GuiContainer> guiClass,
        Collection<IRecipe> recipes)
    {
        IntegratedRecipeHandlerFactory.recipeHandlers
            .add (new FACraftingTableRecipeHandler (unlocalizedName, guiClass, () -> recipes));
    }
        ...
        LOTRTradeEntries itemsSold)
    {
        IntegratedRecipeHandlerFactory.recipeHandlers.add (new FATraderRecipeHandler (
            LOTRRecipeHandlerUtils.getUnlocalizedEntityName (entityClass).replaceAll ("lotrfa.", ""), faction,
